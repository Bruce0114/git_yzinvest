...
fig = make_subplots(rows=4, cols=3, subplot_titles=('10 Seconds Window', '1 Minute Window', '6 Minutes Window'))

# Add traces for 10S
fig.add_trace(go.Scatter(x=resample_trading_10S_df.reset_index()['exchange_time'], y=resample_trading_10S_df['last_price'],
                         name='last_price', line=dict(color='rgb(99,110,250)')), row=1, col=1)
fig.add_trace(go.Scatter(x=resample_trading_10S_df.reset_index()['exchange_time'], y=resample_trading_10S_df['vwap'],
                         name='vwap', line=dict(color='rgb(239,85,59)')), row=2, col=1)
fig.add_trace(go.Scatter(x=resample_trading_10S_df.reset_index()['exchange_time'], y=resample_trading_10S_df['delta_vwap'],
                         name='delta_vwap', line=dict(color='rgb(0,204,150)')), row=3, col=1)
fig.add_trace(go.Scatter(x=resample_trading_10S_df.reset_index()['exchange_time'], y=resample_trading_10S_df['ddelta_vwap'],
                         name='ddelta_vwap', line=dict(color='rgb(171,99,250)')), row=4, col=1)

# Add traces for 1Min
fig.add_trace(go.Scatter(x=resample_trading_df.reset_index()['exchange_time'], y=resample_trading_df['last_price'], showlegend=False,
                         line=dict(color='rgb(99,110,250)')), row=1, col=2)
fig.add_trace(go.Scatter(x=resample_trading_df.reset_index()['exchange_time'], y=resample_trading_df['vwap'], showlegend=False,
                         line=dict(color='rgb(239,85,59)')), row=2, col=2)
fig.add_trace(go.Scatter(x=resample_trading_df.reset_index()['exchange_time'], y=resample_trading_df['delta_vwap'], showlegend=False,
                         line=dict(color='rgb(0,204,150)')), row=3, col=2)
fig.add_trace(go.Scatter(x=resample_trading_df.reset_index()['exchange_time'], y=resample_trading_df['ddelta_vwap'], showlegend=False,
                         line=dict(color='rgb(171,99,250)')), row=4, col=2)

# Add traces for 6Min
fig.add_trace(go.Scatter(x=resample_trading_6M_df.reset_index()['exchange_time'], y=resample_trading_6M_df['last_price'], showlegend=False,
                         line=dict(color='rgb(99,110,250)')), row=1, col=3)
fig.add_trace(go.Scatter(x=resample_trading_6M_df.reset_index()['exchange_time'], y=resample_trading_6M_df['vwap'], showlegend=False,
                         line=dict(color='rgb(239,85,59)')), row=2, col=3)
fig.add_trace(go.Scatter(x=resample_trading_6M_df.reset_index()['exchange_time'], y=resample_trading_6M_df['delta_vwap'], showlegend=False,
                         line=dict(color='rgb(0,204,150)')), row=3, col=3)
fig.add_trace(go.Scatter(x=resample_trading_6M_df.reset_index()['exchange_time'], y=resample_trading_6M_df['ddelta_vwap'], showlegend=False,
                         line=dict(color='rgb(171,99,250)')), row=4, col=3)
...
fig.update_layout(height=1000, width=1900, title_text='Subplots_' + instrument_id + '__10seconds_vs_1minute_vs_6minutes')
